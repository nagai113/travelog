...
if(!defined('CI_THEME_NAME')) 		define('CI_THEME_NAME', 'euclides');
...
if(!defined('CI_THEME_NICENAME')) 	define('CI_THEME_NICENAME', 'Euclides'); 
...
if(!defined('CI_DOCS'))				define('CI_DOCS', 'http://cssigniter.com/support/viewtopic.php?f=18&t=32');
...
if(!defined('CI_FORUM'))			define('CI_FORUM', 'http://cssigniter.com/support/viewforum.php?f=18');
