...
<div class="widgets-area box clearfix">
	...
	<?php 		
		...
		if ( ( function_exists('dynamic_sidebar') && (is_sidebar_active(4)) && is_front_page() ) ) :
		    dynamic_sidebar(4);
		elseif ( ( function_exists('dynamic_sidebar') && (is_sidebar_active(5)) && ( is_single() or is_page() ) && !is_page_template('template-blog.php') && !is_page_template('template-faqs.php') ) ) :
		    dynamic_sidebar(5);
		elseif ( ( function_exists('dynamic_sidebar') && is_sidebar_active(6) && is_archive() or is_search() or ( is_page_template('template-blog.php') or is_page_template('template-faqs.php') ) ) ) :
		    dynamic_sidebar(6);
		endif; 
	?>
