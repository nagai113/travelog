			...
			$options[] = array(	"name" => "Modules Layout Control",
				...
				$options[] = array(	"id" => $shortname."_index_s",
									...
									"options" => array(										
										...
										'logo' => array('name' => __('Logo'), 'show' => true),
										...
										'widgets' => array('name' => __('Front Widgets'), 'show' => false),
				...
				$options[] = array(	"id" => $shortname."_archive_s",
									...
									"options" => array(										
										...
										'widgets' => array('name' => __('Archive Widgets'), 'show' => false),
										'footer' => array('name' => __('Footer Credentials &amp; Navigation'), 'show' => true),
									));
				$options[] = array(	"type" => "sortbottom");
				...
				$options[] = array(	"id" => $shortname."_post_s",
									...
									"options" => array(										
										...
										'widgets' => array('name' => __('Post Widgets'), 'show' => false),
										'footer' => array('name' => __('Footer Credentials &amp; Navigation'), 'show' => true),
									));
				$options[] = array(	"type" => "sortbottom");
	...
	/// Slider Settings											
		...
		$options[] = array(	"name" => "Featured Slider",
			...
			$options[] = array(	"name" => "Display Options",
				...
				$options[] = array(	"name" => "Featured Posts Slider Instructions",
				                    "desc" => "In order to display featured posts slider, make desired posts sticky by checking 'Stick this post to the front page' option under Publish->Visibility section when editing or adding new post. You may also make desired post sticky by clicking 'Quick Edit' option on posts administration. Posts are listed alphabetically and will appear in order they were posted: latest post by date will be first in slider.",
				                    "type" => "help");	
									
				$options[] = array(	"name" => "How many Columns?",
				                    "desc" => "Select into how many columns should the slider posts fit.",
						            "id" => $shortname."_slider_display",
						            "std" => "2",
									"type" => "radio",
									"options" => array("1" => "One Column", "2" => "Two Columns", "3" => "Three Columns", "4" => "Four Columns"));	
									
				$options[] = array( "name" => "Featured Section Name",
				                    "desc" => "Pick a name for you Featured Posts Slider section.",
			    		            "id" => $shortname."_slider_name",
			    		            "std" => "Featured Posts",
			    		            "type" => "text");
									
				$options[] = array(	"name" => "Meta Settings",
				                    "desc" => "Check all fields you would like to display in your slider post meta box.",
				                    "type" => "help");
									
				$options[] = array(	"label" => "Post Author",
									"id" => $shortname."_slmeta_auth",
						            "std" => "false",
						            "type" => "checkbox");
									
			    $options[] = array(	"label" => "Post Category",
									"id" => $shortname."_slmeta_cat",
						            "std" => "false",
						            "type" => "checkbox");
									
				$options[] = array(	"label" => "Post Comments",
									"id" => $shortname."_slmeta_com",
						            "std" => "true",
						            "type" => "checkbox");
			...
			$options[] = array(	"name" => "Image Dimensions",
				...
				$options[] = array(	"name" => "Thumbnail Image Dimensions",
				                    "desc" => "Select image thumbnail dimensions for your features posts slider. If your checked option to Resize Images Dynamically (in Image Setup above), thumbnails will be automatically resized and cropped to fit desired dimensions. Numeric values are defined as pixels (px).",
				                    "type" => "help");
									
				$options[] = array(	"name" => "width",
						            "id" => $shortname."_si_width",
						            "std" => "280",
						            "type" => "text");	
									
				$options[] = array(	"name" => "height",
						            "id" => $shortname."_si_height",
						            "std" => "150",
						            "type" => "text");
