...
if ( function_exists('register_sidebar') )
    register_sidebars(1,array('name' => 'Sidebar 1 (front sidebar)','before_widget' => '<div class="widget">','after_widget' => '</div><!--/widget-->','before_title' => '<h3 class="hl">','after_title' => '</h3>'));
	register_sidebars(1,array('name' => 'Sidebar 2 (single sidebar)','before_widget' => '<div class="widget">','after_widget' => '</div><!--/widget-->','before_title' => '<h3 class="hl">','after_title' => '</h3>'));
	register_sidebars(1,array('name' => 'Sidebar 3 (archive sidebar)','before_widget' => '<div class="widget">','after_widget' => '</div><!--/widget-->','before_title' => '<h3 class="hl">','after_title' => '</h3>'));
	register_sidebars(1,array('name' => 'Module 1 (front module)','before_widget' => '<div class="widget">','after_widget' => '</div><!--/widget-->','before_title' => '<h3 class="hl">','after_title' => '</h3>'));
	register_sidebars(1,array('name' => 'Module 2 (single module)','before_widget' => '<div class="widget">','after_widget' => '</div><!--/widget-->','before_title' => '<h3 class="hl">','after_title' => '</h3>'));
	register_sidebars(1,array('name' => 'Module 3 (archive module)','before_widget' => '<div class="widget">','after_widget' => '</div><!--/widget-->','before_title' => '<h3 class="hl">','after_title' => '</h3>'));
...
class Bizz_Social extends WP_Widget {
	...
	function widget( $args, $instance ) {
		...
		$vimeo = apply_filters( 'widget_vimeo', $instance['vimeo'], $instance );
		...
		if ( !empty( $title ) ) { echo $before_title . $title . $after_title; } ?>
			...
			<?php if ( !empty( $linkedin ) ) { echo '<a href="'.$linkedin.'" class="ico-linkedin sico">'.__('Linked In','bizzthemes') . '</a>'; } ?>
			<?php if ( !empty( $vimeo ) ) { echo '<a href="'.$vimeo.'" class="ico-vimeo sico">'.__('Vimeo','bizzthemes') . '</a>'; } ?>
			<div class="clear"></div>
			</div>
	...
	function form( $instance ) {
		$instance = wp_parse_args( (array) $instance, array( 'title' => '','facebook' => '', 'twitter' => '' ,'flickr' => '' ,'youtube' => '', 'linkedin' => '' ,'vimeo' => '' ) );
		...
		$vimeo = format_to_edit($instance['vimeo']);
...
?>
		...
		<p><label for="<?php echo $this->get_field_id('linkedin'); ?>"><?php _e('Linked In URL:', 'bizzthemes'); ?></label>
		...
		<p><label for="<?php echo $this->get_field_id('vimeo'); ?>"><?php _e('Vimeo URL:', 'bizzthemes'); ?></label>
