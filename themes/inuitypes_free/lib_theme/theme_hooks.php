...
/*------------------------------------------------------------------*/
	...
	require_once (BIZZ_THEME_HOOKS . '/grid.php');
...
/*------------------------------------------------------------------*/
	...
	// lib_theme/hooks/grid.php
	function bizz_head_grid() { do_action( 'bizz_head_grid' ); }
	function bizz_foot_grid() { do_action( 'bizz_foot_grid' ); }
	...
	// lib_theme/hooks/widgets.php
	function bizz_sidebar() { do_action( 'bizz_sidebar' ); }
	function bizz_sidebar_before() { do_action( 'bizz_sidebar_before' ); }
	function bizz_sidebar_after() { do_action( 'bizz_sidebar_after' ); }
