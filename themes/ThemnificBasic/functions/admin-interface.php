...
<div id="themnific-popup-reset" class="themnific-save-popup"><div class="themnific-save-reset">Options Reset</div></div>
    <form action="" enctype="multipart/form-data" id="themnificform">
		...
		<div id="support-links">
			<ul>                
            <li class="left"><a href="http://themnific.com" target="_blank">Enjoy features without limits! Buy Themnific Pro &raquo;</a></li>
...
function themnificthemes_machine($options) {
	...
	foreach ($options as $value) {
		...
		case "typography":
			...
			$output .= '<select class="themnific-typography themnific-typography-unit" name="'. $value['id'].'_unit" id="'. $value['id'].'_unit">';
			...
			*/
			...
			if (strpos($val, 'Open Sans Condensed') !== false){ $font26 = 'selected="selected"'; }
			...
			if (strpos($val, 'Carto') !== false){ $font50 = 'selected="selected"'; }
			if (strpos($val, 'LeagueGothic') !== false){ $font51 = 'selected="selected"'; }
			if (strpos($val, 'BebasNeue') !== false){ $font52 = 'selected="selected"'; }
			if (strpos($val, 'ChunkFive') !== false){ $font53 = 'selected="selected"'; }			
			if (strpos($val, 'FavaBlack') !== false){ $font54 = 'selected="selected"'; }
			if (strpos($val, 'KeytinRegular') !== false){ $font55 = 'selected="selected"'; }
			...
			$output .= '<option value="&quot;CartoGothicStdBold&quot;, sans-serif" '. $font50 .'>Carto**</option>';
			$output .= '<option value="&quot;LeagueGothicRegular&quot;, sans-serif" '. $font51 .'>LeagueGothic**</option>';
			$output .= '<option value="&quot;BebasNeueRegular&quot;, sans-serif" '. $font52 .'>BebasNeue**</option>';	
			$output .= '<option value="&quot;ChunkFiveRegular&quot;, sans-serif" '. $font53 .'>ChunkFive**</option>';			
			$output .= '<option value="&quot;FavaBlack&quot;, sans-serif" '. $font54 .'>FavaBlack**</option>';
			$output .= '<option value="&quot;KeytinRegular&quot;, sans-serif" '. $font55 .'>KeytinRegular**</option>';
			...
			$output .= '<option value="&quot;Open Sans Condensed&quot;, sans-serif" '. $font26 .'>Open Sans Condensed***</option>';
...
//			$jquery_click_hook = "themnific-option-" . str_replace("&","",str_replace("/","",str_replace(".","",str_replace(")","",str_replace("(","",str_replace(" ","",strtolower($value['name'])))))));
