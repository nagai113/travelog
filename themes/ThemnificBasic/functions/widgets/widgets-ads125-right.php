...
class AdWidget125_right extends WP_Widget {

	function AdWidget125_right() {
		$widget_ops = array('description' => 'Use this widget to add any type of Ad as a widget.' );
		parent::WP_Widget(false, __('Themnific - Ads 125px - Right', ''),$widget_ops);      
	}
	...
	function widget($args, $instance) {  
		...
		<?php } else { ?>
			...
			<a href="<?php echo $href; ?>"><img class="ad125_right" src="<?php echo $image; ?>" alt="<?php echo $alt; ?>" /></a>
...
register_widget('AdWidget125_right');
?>