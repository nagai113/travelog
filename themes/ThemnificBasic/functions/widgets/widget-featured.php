                                 ...
                                 <?php
                                    ...
                                    <?php if ($blog_query->have_posts()) : while ($blog_query->have_posts()) : $blog_query->the_post(); ?>
                                        ...
                                        <li class="fblock">
                                            ...
                                            <img class="thumb border" src="<?php echo get_template_directory_uri(); ?>/js/timthumb.php?src=<?php echo thumb_url(); ?>&amp;w=60&amp;h=60&amp;q=90&amp;zc=1" alt="<?php the_title_attribute(); ?>"/>
                                    
                                            <?php } elseif (catch_that_image()) { ?>
                                            <img class="thumb border" src="<?php echo get_template_directory_uri(); ?>/js/timthumb.php?src=<?php echo catch_that_image() ?>&amp;w=60&amp;h=60&amp;q=90&amp;zc=1" alt="<?php the_title_attribute(); ?>"/>
                                            <?php } else { ?>
                                            <?php } ?>
